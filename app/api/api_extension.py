...
api = Api(
    ...
    + "The flutter client for the Mentorship system can be found here: https://github.com/anitab-org/mentorship-flutter\n \n "
    + "The ios client for the Mentorship system can be found here: https://github.com/anitab-org/mentorship-ios"
